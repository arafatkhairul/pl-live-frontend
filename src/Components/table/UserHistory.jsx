...
const UserHistory = (props) => {
  ...
  useEffect(() => {
    dispatch(getUserHistory(id, startDate, endDate, activePage, rowsPerPage, type));
  }, [dispatch, id, startDate, endDate, activePage, rowsPerPage, type]);
  ...
  const handleApply = (event, picker) => {
    ...
    dispatch(getUserHistory(id, start, end, activePage, rowsPerPage, type));
  };

...
const HostHistoryTable = (props) => {
  ...
  const handleApply = (event, picker) => {
    ...
    setStartDate(start);
    setEndDate(end);
    dispatch(getHostHistory(id, type, activePage, rowsPerPage, start, end));
  };
  ...
  useEffect(() => {
    dispatch(
      getHostHistory(id, type, activePage, rowsPerPage, startDate, endDate)
    );
  }, [dispatch, id, type, activePage, rowsPerPage, startDate, endDate]);
  ...
  return (
    <>
      <div className="row py-2">
        <div class="col-2">
          <h4 className="hostTitle">History </h4>
        </div>
        <div class="col-12">
                ...
                <div class="col-xl-4 col-md-4 float-right col-sm-12 col-12 filtered-list-search ">
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-3 col-sm-6 col-6">
                      <div className="mt-2 d-flex justify-content-center align-items-center">
                        <button
                          className="btn bg-success-gradient text-white"
                          onClick={() => setType("coinPlan")}
                        >
                          Purchase
                        </button>
                      ...
                      <div className="table-responsive">
                        <table className="table text-center  mb-4 table-striped">
                          <thead className="border-top">
                            <tr className="text-center pt-1">
                              <th className="fw-bold fs-6">No</th>
                              <th className="fw-bold fs-6">host Name</th>
